                ...
                <ListViewProductLeftDiv>
                    {
                        sliceData.map(data=> <div>
                            ...
                            <Link to='/blog-with-right-sidebar-page2'><KeyboardDoubleArrowRightIcon /></Link>
                        </MorePageDiv>
                </ListViewProductLeftDiv>
...
export const MassageAndInformationDiv=style.div`
display:flex;
justify-content:space-evenly;
`

export const MassageDiv=style.div`
width:360px;
height:200px;
display:flex;
flex-direction:column;
...
export const OurStoreDiv=style.div``

export const CompanyDiv=style.div``

export const SocialMediaDiv=style.div`
div{
    width:200px;
    display:flex;
...
export const FacebookIconDiv=style(FacebookIcon)`
`