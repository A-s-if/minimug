...
import ProductData from '../../../JSON DATA/Blogs/GridLayoutPage2/GridLayoutPage2.json';
...
const BlogWithLeftSidebarPage3 = () => {
    return (
        <Container>
            {/* Navigation */}
            ...
            <MorePageDiv>
                    <Link to='/blog-with-left-sidebar-page2'><KeyboardDoubleArrowLeftIcon /></Link>
...
export default BlogWithLeftSidebarPage3;
