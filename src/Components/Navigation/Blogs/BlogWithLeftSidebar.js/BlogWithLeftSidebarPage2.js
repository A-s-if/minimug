...
const BlogWithLeftSidebarPage2 = () => {
    ...
    return (
        <Container>
            ...
            <MorePageDiv>
                    <Link to='/blog-with-left-sidebar-page1'><KeyboardDoubleArrowLeftIcon /></Link>
                    ...
                    <Link to='/blog-with-left-sidebar-page3'><KeyboardDoubleArrowRightIcon /></Link>
                </MorePageDiv>
...
export default BlogWithLeftSidebarPage2;
